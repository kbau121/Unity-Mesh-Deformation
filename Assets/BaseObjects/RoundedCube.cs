/// Reference Source: https://catlikecoding.com/unity/tutorials/rounded-cube/
...
public class RoundedCube : MonoBehaviour
{
    ...
    private void CreateColliders()
    {
        ...
        Vector3 sizeR = size - Vector3.one * roundness * 2;
        AddBoxCollider(size.x, sizeR.y, sizeR.z);
        AddBoxCollider(sizeR.x, size.y, sizeR.z);
        AddBoxCollider(sizeR.x, sizeR.y, size.z);
